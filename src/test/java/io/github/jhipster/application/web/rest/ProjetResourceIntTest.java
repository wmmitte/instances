...
public class ProjetResourceIntTest {
    ...
    public void createProjet() throws Exception {
        ...
        assertThat(testProjet.getStatut()).isEqualTo(DEFAULT_STATUT);
        assertThat(testProjet.getNext()).isEqualTo(DEFAULT_NEXT);
        assertThat(testProjet.getCommentaire()).isEqualTo(DEFAULT_COMMENTAIRE);
    }
    ...
    public void getAllProjets() throws Exception {
        ...
        restProjetMockMvc.perform(get("/api/projets?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].next").value(hasItem(DEFAULT_NEXT.toString())))
    ...
    public void getProjet() throws Exception {
        ...
        restProjetMockMvc.perform(get("/api/projets/{id}", projet.getId()))
            ...
            .andExpect(jsonPath("$.next").value(DEFAULT_NEXT.toString()))
    ...
    public void updateProjet() throws Exception {
        ...
        assertThat(testProjet.getStatut()).isEqualTo(UPDATED_STATUT);
        assertThat(testProjet.getNext()).isEqualTo(UPDATED_NEXT);
        assertThat(testProjet.getCommentaire()).isEqualTo(UPDATED_COMMENTAIRE);
    }
